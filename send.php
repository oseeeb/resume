...
$uploadFileName = $uploadDir.basename($_FILES['file-1']['name']).$today;
...
$recipient = "ebouaepane@gmail.com";// Change the recipient email adress to your adrees  
